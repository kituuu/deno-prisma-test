  ...
  */
    ...
    model: {
      Dinosaur: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.DinosaurFindRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          aggregateRaw: {
            args: Prisma.DinosaurAggregateRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          count: {
  ...
  export interface DinosaurDelegate<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> {
    ...
    **/
    ...
    /**
     * Find zero or more Dinosaurs that matches the filter.
     * @param {DinosaurFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const dinosaur = await prisma.dinosaur.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: DinosaurFindRawArgs
    ): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Dinosaur.
     * @param {DinosaurAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const dinosaur = await prisma.dinosaur.aggregateRaw({
     *   pipeline: [
  ...
  interface DinosaurFieldRefs {
    ...
    readonly userid: FieldRef<"Dinosaur", 'String'>
  }
   ...
   * Dinosaur findRaw
   */
  export type DinosaurFindRawArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * Dinosaur aggregateRaw
   */
  export type DinosaurAggregateRawArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
  ...
  export type DinosaurWhereInput = {
    ...
    userid?: StringFilter<"Dinosaur"> | string
  }
  ...
  export type DinosaurScalarWhereWithAggregatesInput = {
    ...
    userid?: StringWithAggregatesFilter<"Dinosaur"> | string
  }
